...
class PasswordReset(Base):
    ...
    pwreset_id = Column(Integer, primary_key = True, autoincrement = True)
...
class Edge(Base):
    ...
    # head node
    head_user_id = Column(String, primary_key = True)
    head_graph_id = Column(String, primary_key = True)
    head_id = Column(String, primary_key = True)

    # tail node
    tail_user_id = Column(String, primary_key = True)
    tail_graph_id = Column(String, primary_key = True)
    tail_id = Column(String, primary_key = True)
    # label of this edge
