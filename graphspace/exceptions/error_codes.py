class ErrorCodes(object):
	...
	class Validation(object):
		...
		NotAllowedGraphAccess = (1007, "User is not authorized to access private graphs created by {0}.")
		CannotCreateGraphForOtherUser = (1008, "Cannot create graph with owner email = `{0}`.")
		GraphIDMissing = (1009, "Graph ID is missing.")

		# Groups API
		NotAllowedGroupAccess = (1010, "User is not authorized to access groups they aren't part of. Set `owner_email` or `member_email` to {0}.")
		CannotCreateGroupForOtherUser = (1011, "Cannot create group with owner email = `{0}`.")
		...
		GraphNameSize = (1015, "Graph Name cannot be more than 256 characters long.")