...
def convert_unicode_node_shape(node_shape):
	acceptedShapes = {u'\u25a0':"rectangle", u'\u25b2':"triangle", u'\u25cf':"circle", u'\u2605': "star", u'\u25fe': "square"}
	new_node_shape = []
	for x in node_shape:
		new_node_shape.append(acceptedShapes[x])
	return new_node_shape

def convert_unicode_edge_shape(edge_shape):
	acceptedShapes  = {u'\u27f6':"triangle", u'\u22a3':"tee", u'\u2014':"none"}
	new_edge_shape = []
	for x in edge_shape:
		new_edge_shape.append(acceptedShapes[x])
	return new_edge_shape

def convert_html_legend_1(graph_json,  style_json):
	html_table_string = json.dumps(graph_json["data"]['description'])
